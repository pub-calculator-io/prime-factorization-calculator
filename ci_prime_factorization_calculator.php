...
Version: 1.0.0
Author: Prime Factorization Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Prime Factorization Calculator by www.calculator.io";

function display_calcio_ci_prime_factorization_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_prime_factorization_calculator', 'display_calcio_ci_prime_factorization_calculator' );